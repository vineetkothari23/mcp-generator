"""
lynnx-blog-mcp-server - Configuration Management

Configuration settings for the lynnx_blog_mcp_server MCP server.
...
class Lynnx_blog_mcp_serverConfig(BaseSettings):
    """
    Configuration for lynnx_blog_mcp_server MCP server
    
    Loads settings from environment variables with MCP_ prefix.
    """
    
    # Server settings
    server_name: str = Field("lynnx-blog-mcp-server", description="MCP server name")
